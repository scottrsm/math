...
$A$ is $n \times m$ and ${\bf x}$ and
${\bf b}$ are $m \times 1$ and $n \times 1$ random variables respectively. The
...
positive semi-definite). The constraint $g(L) = 0$ is vacuous since $\Omega$ already
encodes $LA = I$. Theorem 1 follows after collecting the facts:

\item{For a positive semi-definite matrix with eigenvalues $\lambda_i \ge 0$,
$\root k \of {\sum_i \lambda_i^k} \to \max_i \lambda_i$ as $k \to \infty$.}
\item{The $L_2$ matrix norm of a positive semi-definite matrix is its
maximum eigenvalue.}
