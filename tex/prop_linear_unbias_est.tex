...
positive definite matrix $M_{m \times m}$ (these are the {\it Schatten\/}
$k$-norms of $M$).
...
$\varphi_n(L) = \sqrt[n]{{\rm tr}((LVL^T)^n)}$ (the $n^{\rm th}$ Schatten norm of $LVL^T$),
...
$\sqrt[k]{\sum_i \lambda_i^k} \to \max_i \lambda_i$ as $k \to \infty$.}
