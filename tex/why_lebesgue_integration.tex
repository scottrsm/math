...
intervals -- and also on a finite collection of intervals.
...
Then for any
$\epsilon > 0$, $Q_{[0,1]} \subset \mathop{\cup}_{i=1}^\infty\limits I_{(r_i - \frac{\epsilon}{2^i}, r_i + \frac{\epsilon}{2^i})}$.
Then $\forall \epsilon > 0$:
\begin{align}
\mu^*(Q_{[0,1]}) &\le \sum_{i=1}^\infty  |I_{(r_i - \frac{\epsilon}{2^i}, r_i + \frac{\epsilon}{2^i})}| \\
