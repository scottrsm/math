...
It is also known that all prime factors, $p$, of elements in ${\cal H}$ have the property that $p = 1 \; {\rm mod} \; 4$.
The first conjecture -- which must be suspected by the mathematical community -- states that such primes constitute the set ${\cal H}_p$. 
\conjecture{The set ${\cal H}_p = \{ p \; | \; p \in \mathbb{P} \; \wedge \; p = 1 \; {\rm mod}\;  4\}$

Immediate Corollary from this conjecture:
The set ${\cal H}$ has a unique factorization in ${\cal H}_p$. That is, each element of ${\cal H}$ can be uniquely written as a product of powers from ${\cal H}_p$:
  \begin{eqnarray}
