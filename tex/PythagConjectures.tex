...
\conjecture{The set ${\cal H}$ has a unique factorization in ${\cal H}_p$. That is, each element of ${\cal H}$ can be uniquely written as a product of powers from ${\cal H}_p$.
  \begin{eqnarray}
