...
{\bf Definition.} Let ${\bf x}, {\bf y}$ be vectors and let $a$ be a number.
...
form a triangle. By the converse of the Pythagorean theorem, when
$\|{\bf p}\|^2 = \|{\bf p}_v\|^2 + \|{\bf w}\|^2$, ${\bf p}_v$ is perpendicular
to ${\bf w}$. That is, ${\bf p}_v \cdot {\bf w} = 0$ characterizes
${\bf p}_v$ and ${\bf w}$ being perpendicular.
...
\be
  P_{[{\bf v}_1, {\bf v}_2]}({\bf x}) & = & ( {\bf x} \cdot {\bf v}_1 ) {\bf v}_1 +  ( {\bf x} \cdot {\bf v}_2 ) {\bf v}_2  \label{proj2}
\ee

{\bf Def.} We define $P_{[{\bf v}_1, \ldots, {\bf v}_m]}$ to be the projection
...
\be
  P_{[{\bf v}_1, \ldots, {\bf v}_m]}({\bf x}) & = & \sum_{i=1}^m ( {\bf x} \cdot {\bf v}_i) {\bf v}_i \label{projection}
\ee
