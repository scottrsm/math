...
that touches the hypotenuse and the leg. It is clear that the radius of
such circles grow as one moves out along the bisector. Consequently, there is
a point on the bisector where the circle touches the opposite leg.
