...
common factors? The possibilities are: 
\begin{itemize}
    \item{$c$ is even and exactly one of the following is true:}
        \begin{itemize}
            \item{Both $a$ and $b$ are even;}
            \item{Both $a$ and $b$ are odd;}
            \item{One of either $a$ or $b$ is even and the other is odd.}
        \end{itemize}
    \item{$c$ is odd and exactly one of the following is true:}
        \begin{itemize}
            \item{Both $a$ and $b$ are even;}
            \item{Both $a$ and $b$ are odd;}
            \item{One of either $a$ or $b$ is even and the other is odd.}
...
\begin{itemize}
    \item{$c$ is odd AND one of either $a$ or $b$ is even and the other is odd.}
\end{itemize}
Let's say that it is $b$; in which case, $a$ is odd.
