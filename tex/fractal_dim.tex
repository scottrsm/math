...
\mantitle{Defining Fractal Dimension}{R. Scott McIntire}{Apr 26, 2026}
...
finite and each has diameter no larger than $\epsilon$.\ftn{This is the
...
${\cal V}_{\alpha, \epsilon_1}(S)$ is a {\tt subset\/} of those used to
...
{\tt Sierpi\'{n}ski triangle\/} (a different object from the 3-dimensional
