...
Menger sponge mentioned in the introduction, although both are sometimes
loosely called ``sponges''); it is ``best'' described in a recursive way
as a scaled version of the lower triangular portion of itself, and its
fractal dimension is $\ln 3 / \ln 2 \approx 1.585$.
