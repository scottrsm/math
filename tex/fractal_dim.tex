...
\mantitle{Defining Fractal Dimension}{R. Scott McIntire}{Mar 7, 2024}
...
{\parindent=0pt
3\ft{*}{The zero dimension of a set is the number of points in
...
\ft{\dag}{We use the functions: ${\cal S}$ and ${\cal V}$ 
...
\ft{\ddag}{The function $\Gamma(n)$ is called the Gamma function and 
...
\ft{\dag}{The volume of an $n$-dimensional sphere scales by the radius to the $n^{\rm th}$ power.}
...
\ft{*}{The set $R^+$ is defined by: $R^+ = \{x \, | \, x\in R \; \wedge \; x\ge 0\}$.}
$$
...
is defined as\ft{\dag}{The diameter of a set is defined by: 
...
\section{Appendix A: Examples of Self-Similar Fractals \hfill}
