...
Any roll of the die will produce one of these faces with an equal probability. Lets further suppose
that the value of each side is the number of dots on the die. Know suppose that we when the die is 
rolled, we don't see the die, but someone tells us partial information -- only that the die is "even" or "odd".

{\bf Question:\/} Given that we only know the even or oddness of the die, what is the "best" quess of the die value?
...
like a naturalG candidate for the conditional expectation it is not necessarily
...
\E{f/{\cal F}}\!(\Lambda_1)  & =  \frac{\int_{\Lambda_1} f \, dP}{P_{\cal F}(\Lambda_1)} = f(D_1) * \frac{P(D_1)}{P(\Lambda_1)} + f(D_3) * \frac{P(D_3)}{P(\Lambda_1)} + f(D_5) * \frac{P(D_5)}{P(\Lambda_1)} & \cr 
\E{f/{\cal F}}\!(\Lambda_1)  & =  \frac{\int_{\Lambda_1} f \, dP}{P_{\cal F}(\Lambda_1)} = 1 * \frac{\frac{1}{6}}{\frac{1}{2}} + 3 * \frac{\frac{1}{6}}{\frac{1}{2}} + 5 * \frac{\frac{1}{6}}{\frac{1}{2}} & \cr 
\E{f/{\cal F}}\!(\Lambda_1)  & =  \frac{\int_{\Lambda_1} f \, dP}{P_{\cal F}(\Lambda_1)} = 1 * \frac{1}{3} + 3 * \frac{1}{3} + 5 * \frac{1}{3} & \cr 
...
\eqalignno{
	E[\E{f / g}] & = \int_{X} \E{f / g} \, dP = \int_{X} f \, dP & (6') \cr
											 ...
											 & = \sum_{i=1}^N \E{f / g}(M_i)\, P(M_i) & (7') \cr
}
$$
Here, the term, $\E{f / g}(M_i)$ is interpreted as the value of $\E{f / {\cal F}}$ on {\it any\/} element of the set $M_i$ -- 
...
is the same as the expectation of $f$. Equation (7') states that 
