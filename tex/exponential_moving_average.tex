...
\begin{flalign}
    ...
    + \sum_{i=1}^N \sum_{j=2}^r \sum_{k=2}^j (-1)^j \binom{r}{j} \binom{j}{k} M_{r-k} &&\\\nonumber
    & \quad  \times  \sum_{\substack{k_1 + k_2 \ldots + k_N = k \\ \forall n, k_n \ge 0 \\ k_i = 0}} \binom{k}{k_1, k_2, \ldots, k_N} 
...
\begin{flalign}
    ...
    & \quad + \sum_{i=1}^N \left( 
     \sum_{\substack{k_1 + k_2 \ldots + k_N = 2 \\ \forall n, k_n \ge 0 \\ k_i = 0}} \binom{2}{k_1, k_2, \ldots, k_N} 
