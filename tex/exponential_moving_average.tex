...
Substituting these three results into $(\ref{standard_emp_var})$:
\begin{align*}
...
As a last example we try the case $r=4$. Substituting directly into the general
formula above gets unwieldy; we instead organize the computation by the value
of $k$, the power of $\sum_{l \neq i} (x_l - \mu) w_l$ that appears.
