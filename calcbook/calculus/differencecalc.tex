...
\enum{The first half of the {\it approximate, then take a limit\/} strategy:
replace a slowly varying quantity (the fuzzing factor $f_n$) by a constant.
The second half -- refining the approximation with a limit -- arrives in the
chapter on Differential Calculus.}
\endEnum
