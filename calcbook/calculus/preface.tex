...
These convictions turn out to have distinguished company in the
mathematics education literature. The idea that a tool should answer a
question the student already has is what Harel calls {\it intellectual
need\/}; the conviction that a student should feel they could have
invented the material is what Freudenthal called {\it guided
reinvention\/}; organizing a subject around recurring ways of thinking
rather than topics is the {\it habits of mind\/} program of Cuoco,
Goldenberg, and Mark; the strategic moves themselves stand in the
tradition of P\'olya's heuristics; and the discontent with the standard
ordering of calculus has company in Bressoud. The study method of the
final appendix rests on a century of memory research. Full citations for
all of these are collected in the References at the end of the book.
