...
goes around them. Full citations are collected in the References section
at the end of the book.} -- and on a piece of good luck: you have something no
...
or differential equation, name the strategic move (isolate and invert)
and the tool that executes it (summing factor or integrating factor),
and solve it. Grade the setup, the move-and-tool choice, and the
...
viva (as the British call an oral exam) goes badly in places, that is
the system working -- you have found the soft spots while they are
still cheap to repair.
